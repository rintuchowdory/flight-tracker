const PROXY = "https://opensky-proxy.chowdoryrintu.workers.dev";
...
function initMap() {
  ...
  L.control.attribution({ position: "bottomleft", prefix: "© OpenStreetMap | ADS-B" }).addTo(map);
...
function showFlightPanel(flight) {
  ...
  document.getElementById("panel-content").innerHTML =
    ...
    "<div class='data-cell'><span class='data-cell-label'>LAT</span><span class='data-cell-value'>" + (flight.lat||0).toFixed(4) + "</span></div>" +
    "<div class='data-cell'><span class='data-cell-label'>LON</span><span class='data-cell-value'>" + (flight.lon||0).toFixed(4) + "</span></div>" +
    "</div>" +
